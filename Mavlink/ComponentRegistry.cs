...
public sealed class ComponentRegistry
{
    ...
    public IEnumerable<IMavlinkComponent> GetMessageRecipients(uint messageId, byte targetSystem, byte targetComponent) => _components.Where(x => x.HandledMessageIds.Contains(messageId) && (targetSystem == 0 || targetSystem == x.SystemId) && (targetComponent == 0 || targetComponent == x.ComponentId));
}
