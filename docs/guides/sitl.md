...
Load [sitl-minimal.param](https://github.com/ComputerComa/MavlinkDeviceServer/blob/master/sitl-minimal.param) through your normal SITL
...
[sitl-minimal.param](https://github.com/ComputerComa/MavlinkDeviceServer/blob/master/sitl-minimal.param) to that location, or update the
