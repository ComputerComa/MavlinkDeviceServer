...
public sealed class CameraComponent(byte systemId, byte componentId) : MavlinkComponentBase(systemId, componentId) { public override IReadOnlyCollection<uint> HandledMessageIds { get; } = [76]; }
